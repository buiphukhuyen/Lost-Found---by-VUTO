export default {
  ...
  START_OKAY: '[BOT] Đợi xíu nhé! Hệ thống sẽ thông báo ngay cho bạn khi tìm được ^.^',
  START_WARN_GENDER: '[BOT] Lưu ý: Bạn không chọn Giới tính. Có thể bạn sẽ phải đợi lâu hơn.',
  START_ERR_ALREADY: '[BOT] Bạn không thể Bắt đầu Cuộc trò chuyện mới khi chưa Kết thúc...',

  WAITING: '[BOT] Đang tìm bạn Chat... Nếu bạn muốn đổi Giới tính, gửi "Kết thúc" sau đó Chọn Giới tính mới.',
  CONNECTED: '[BOT] Ping Ping! Đã tìm thấy bạn rồi! Gửi lời chào với nhau nào!',

  END_CHAT: '[BOT] Kết thúc Chat!\nGửi "Bắt đầu chat" hoặc Chọn nút bên dưới để tìm bạn chat. \n[Bổ sung]Hãy Gửi yêu cầu trong trường hợp phát hiện lỗi hay bị quấy rối',
  END_CHAT_PARTNER: '[BOT] Hic! Bạn ý đã ngắt kết nối rồi \nGửi "Bắt đầu chat" hoặc bấm vào nút để Tìm bạn Chat mới nha!',
  END_CHAT_FORCE: '[BOT] Hiện tại không tìm thấy được bạn chat phù hợp. Bạn hãy thử lại nhé!',
  ...
  ERR_10: '[BOT] Bạn Chat không thể nhận tin nhắn do 2 bạn không nói chuyện trong 24h. Gửi "Kết thúc" để kết thúc chat.',
